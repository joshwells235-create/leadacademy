  ...
  if (loading) {
    return (
      <div className="rounded-lg border border-neutral-200 bg-white p-5 shadow-sm">
        <h2 className="text-sm font-semibold text-brand-navy">Today's practice</h2>
    ...
    return (
      <div className="rounded-lg border border-neutral-200 bg-white p-5 shadow-sm">
        ...
        <p className="mt-2 text-sm text-neutral-600">
          Couldn't load today's practice right now. Reload the page in a minute — your thought
  ...
  if (!challenge) {
    return (
      <div className="rounded-lg border border-neutral-200 bg-white p-5 shadow-sm">
        <h2 className="text-sm font-semibold text-brand-navy">Today's practice</h2>
        <p className="mt-2 text-sm text-neutral-600">
          Nothing yet — check back in a moment. Your thought partner is drafting today's practice,
          grounded in your goals and recent reflections.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="rounded-lg border border-neutral-200 bg-white p-5 shadow-sm">
      <div className="flex items-start justify-between">
        <div>
          <h2 className="text-sm font-semibold">Today's practice</h2>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={completing}
                  className="rounded-md bg-brand-navy px-3 py-1.5 text-sm font-medium text-white hover:opacity-90 disabled:opacity-60"
                >
