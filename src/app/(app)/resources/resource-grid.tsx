          ...
          {filtered.map((r) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-sm font-semibold text-brand-navy group-hover:text-brand-blue transition">
                  {r.title}
                </h3>
                {r.description && (
                  <p className="mt-0.5 text-xs text-neutral-600 line-clamp-2">{r.description}</p>
                )}
              ...
              <span className="text-xs text-neutral-400 group-hover:text-brand-blue shrink-0 self-center">
                ↗
              </span>
            </a>
          ))}
