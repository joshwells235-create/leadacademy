...
function buildIntakeOpener(firstName: string | null): string {
  ...
  return [
    ...
    "• What you add to Leadership Academy — your profile, goals, reflections, actions, assessment uploads — is visible to your human coach. That's intentional: it's what lets them show up knowing you.",
    "• Our back-and-forth here stays between you and me. The coach sees that we talked, not what we said.",
